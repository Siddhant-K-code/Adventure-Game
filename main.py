...
while dead == False or complete == False:
	if path == "START":
		...
		Path("You wake up, you are in a dark, cold, small room, with only a rusted iron door in front of your eyes, a large man walks in, light interrogating you from behind the door, he grabs you, you try to struggle but you are weak from lying in the room for so long, you give up, and let him take you forward. You and the large man walk for a while through the whitewashed, windowless hall for what fells like an eternity, you stop, he reaches forward, clasping his security card, and a part of the wall opens, he throws you towards the opening, making you fly and skid on the ground, torn and blodied, and closes the door behind you. What do you do?", ["Immediately run and try to destroy the door you are locked behind", "Asses the area, see what is around you", "Lay down and try to sleep"], ["The door isn't there, interesting...", "You look around...", "Whilst in your sleep, you were attacked by something and died."], ["START", "ForestInspect", "DEAD"])
	...
	if path == "FollowRiver":
		Path("Ahed, you spot a crocodile waiting near the water, it spots you.", ["Carry on, hope it doesn't attack you", "Attack it", "Run"], ["The crocodile's hungry, while you approach near, it attacks you", "You ayttack the crocodile, you have no weapons, it defeats you", "You run back, regroup, and enter the forest again"], ["DEAD", "DEAD", "ForestEnter"])
